"""
generate_trajectory_stereo.py
------------------------------
Same trajectory generation as generate_trajectory.py but writes to /mnt/data/datasets.

Usage:
    python generate_trajectory_stereo.py --scene_name scene_001_circle --traj_type circle --duration 100
"""
...
def main():
    ...
    output_dir = os.path.join(DATASETS_DIR, args.scene_name)
